...
#_tokenLogin("ElF49lVzVm3OKzADJ21a.apGNZMzba418M2CeQxD9/G.LVfqijcBsUIxrOfUxpoU8Wub0srvDNddV/wd+OG3RwE=")
...
def NOTIFIED_KICKOUT_FROM_GROUP(op):
    try:
        ...
        #sendMessage(op.param1, client.getContact(op.param3).displayName + " ได้ออกจากกลุ่ม\n(*´･ω･*)")
    except Exception as e:
        print 
